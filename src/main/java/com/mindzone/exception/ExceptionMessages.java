...
public class ExceptionMessages {
    ...
    public static final String OAUTH_USER_NOT_FOUND = "OAUTH_USER_NOT_FOUND";
    ...
    public static final String THERAPY_IS_NOT_EDITABLE_ANYMORE = "THERAPY_IS_NOT_EDITABLE_ANYMORE";
